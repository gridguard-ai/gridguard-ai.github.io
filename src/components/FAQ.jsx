    ...
    >
      ...
      <div className="section-container relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 animate-on-scroll">
          <span className="inline-block px-4 py-2 bg-emerald-500/10 text-emerald-700 font-semibold text-sm rounded-full mb-4">
            Common Questions
          </span>
          <h2
            id="faq-heading"
          ...
          <p className="mt-4 text-lg text-stone-600">{FAQ_DATA.sectionSubtitle}</p>
        </div>
...
function AccordionItem({ item, index, isOpen, onToggle, onKeyDown, buttonRef }) {
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-lg font-semibold text-stone-900 pr-4">{item.question}</span>
        <span
      ...
      >
        <div className="p-5 pt-0 text-stone-600 leading-relaxed border-t border-stone-200">
          {item.answer}
        </div>
      </div>
    </div>
