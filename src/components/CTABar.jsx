...
function CTABar() {
  ...
  return (
    <section
      id="cta"
      ref={sectionRef}
      className="section-padding relative overflow-hidden bg-stone-900"
      aria-labelledby="cta-heading"
    >
      {/* Rich gradient background with brand colors */}
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-br from-amber-950 via-stone-900 to-stone-800" />
      ...
      <div className="section-container relative z-10">
        <div className="max-w-2xl mx-auto text-center animate-on-scroll">
          {/* Badge */}
          <span className="inline-block px-4 py-2 bg-orange-500/20 text-orange-400 font-semibold text-sm rounded-full mb-6">
            Early Access
          </span>
          ...
          <p className="mt-4 text-lg text-stone-400">{CTA.subheadline}</p>
