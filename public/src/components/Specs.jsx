...
function Specs() {
  ...
  return (
    <section
      id="specs"
      ref={sectionRef}
      className="section-padding relative overflow-hidden bg-stone-50"
      aria-labelledby="specs-heading"
    >
      {/* Background with warm gradient */}
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-br from-stone-50 via-stone-100/50 to-orange-50/30" />
        {/* Decorative elements */}
      ...
      <div className="section-container relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 animate-on-scroll">
          <span className="inline-block px-4 py-2 bg-amber-900/10 text-amber-800 font-semibold text-sm rounded-full mb-4">
            Technical Details
          </span>
          <h2
            id="specs-heading"
            className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-stone-900"
          >
            {SPECS.sectionTitle}
          </h2>
          <p className="mt-4 text-lg text-stone-600">{SPECS.sectionSubtitle}</p>
        </div>
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm text-stone-500 mb-1">{spec.label}</p>
